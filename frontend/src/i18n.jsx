...
const translations = {
  ...
  de: {
    ...
    satelliteViewLead: 'Eine kurze, verständliche Vorstellung des Satelliten hinter unseren NO₂-Daten.',
    ...
    measurementNote: 'Regionaler Satellitendurchschnitt für die ausgewählte Region. Anzeige nicht in Echtzeit.',
