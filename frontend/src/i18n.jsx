...
const translations = {
  sl: {
    ...
    adminLoginTitle: 'Prijava v skrbniški pregled',
    adminLoginSubtitle: 'Skrbniški pregled je dostopen samo prijavljenim operaterjem podatkovne cevi.',
    adminLoginPasswordLabel: 'Geslo',
    adminLoginSubmit: 'Prijava',
    adminLoginError: 'Napačno geslo. Poskusite znova.',
    adminLoginVerifying: 'Preverjam ...',
    adminLoginNetworkError: 'Strežnik ni dosegljiv. Preverite povezavo.',
    adminLoginDisabledError: 'Skrbniški dostop ni nastavljen na strežniku (ADMIN_PASSWORD ni nastavljen).',
    adminLoginHint: 'Prijava velja do zaprtja zavihka.',
    adminLogout: 'Odjava',
  ...
  en: {
    ...
    adminLoginTitle: 'Admin dashboard sign-in',
    adminLoginSubtitle: 'The admin dashboard is restricted to authorised data-pipeline operators.',
    adminLoginPasswordLabel: 'Password',
    adminLoginSubmit: 'Sign in',
    adminLoginError: 'Incorrect password. Please try again.',
    adminLoginVerifying: 'Verifying...',
    adminLoginNetworkError: 'The server is unreachable. Check your connection.',
    adminLoginDisabledError: 'Admin access is not configured on the server (ADMIN_PASSWORD is not set).',
    adminLoginHint: 'You will stay signed in until you close this tab.',
  ...
  de: {
    ...
    adminLoginTitle: 'Anmeldung am Admin-Bereich',
    adminLoginSubtitle: 'Der Admin-Bereich ist nur für autorisierte Betreiber der Datenpipeline zugänglich.',
    adminLoginPasswordLabel: 'Passwort',
    adminLoginSubmit: 'Anmelden',
    adminLoginError: 'Falsches Passwort. Bitte erneut versuchen.',
    adminLoginVerifying: 'Überprüfung ...',
    adminLoginNetworkError: 'Der Server ist nicht erreichbar. Bitte Verbindung prüfen.',
    adminLoginDisabledError: 'Der Admin-Zugang ist auf dem Server nicht konfiguriert (ADMIN_PASSWORD ist nicht gesetzt).',
    adminLoginHint: 'Sie bleiben angemeldet, bis Sie diesen Tab schließen.',
