...
const translations = {
  sl: {
    ...
    measurementNote: 'Satelitsko regionalno povprečje za izbrano regijo. Prikaz ni v realnem času.',
    loading: 'Nalaganje...',
    noData: 'Ni podatka',
    today: 'danes',
    yesterday: 'včeraj',
    ...
    regionRank: 'Uvrstitev',
    capitalCity: 'glavno mesto',
    tooltipNoDataNote: 'Za ta prelet ni bilo dovolj kakovostnih satelitskih podatkov.',
    qaThreshold: 'QA prag',
    rankLabel: 'Uvrstitev',
  ...
  en: {
    ...
    measurementNote: 'Satellite regional average for the selected region. The display is not real-time.',
    loading: 'Loading...',
    noData: 'No data',
    today: 'today',
    yesterday: 'yesterday',
    ...
    tooltipNoDataNote: 'Not enough good-quality satellite data for this overpass.',
  ...
  de: {
    ...
    mapViewLead: 'Klicken Sie auf eine Region, um sie auszuwaehlen. Die Farbe zeigt die NO2-Abweichung vom Regionsdurchschnitt.',
    ...
    measurementNote: 'Regionaler Satellitendurchschnitt fuer die ausgewaehlte Region. Anzeige nicht in Echtzeit.',
    ...
    tooltipNoDataNote: 'Fuer diesen Ueberflug gab es nicht genug qualitativ gute Satellitendaten.',
    ...
    deviationAboveAverage: 'Ueber Durchschnitt',
    deviationWellAboveAverage: 'Deutlich ueber Durchschnitt',
    ...
    mapModeQuality: 'Datenqualitaet',
    mapLegendRelativeScale: 'relative Skala',
    mapLegendValueHint: 'Eine dunklere Farbe bedeutet einen hoeheren NO₂-Wert unter den gezeigten Regionen.',
    mapLegendQualityHint: 'Die Farbe zeigt den Qualitaetsstatus der Messung je Region.',
    mapResetView: 'Ansicht auf ganz Slowenien zuruecksetzen',
    activeOnMap: 'Auf der Karte ausgewaehlt',
    mapHint:
      'Klicken Sie auf eine Region, um sie auszuwaehlen. Farben zeigen die neuesten NO2-Werte; Abweichungen vom Mittelwert sind ueber die Schaltflaeche verfuegbar. Der Punkt zeigt den Qualitaetsstatus.',
